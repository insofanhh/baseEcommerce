...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('BE/assets/imgs/theme/favicon-01.png') }}" />
    <!-- Template CSS -->
    ...
    <aside class="navbar-aside" id="offcanvas_aside">
        <div class="aside-top">
            <a href="index.html" class="brand-wrap">
                <img src="{{ asset('BE/assets/imgs/theme/logo-3.png') }}" class="logo" alt="Nest Dashboard" />
            </a>
            <div>
        ...
        <nav>
            <ul class="menu-aside">
                ...
                <li class="menu-item has-submenu">
                    ...
                    <div class="submenu">
                        <a href="{{ route('allproducts') }}">Product List</a>
                        <a href="{{ route('allcategory') }}">Categories</a>
                        <a href="{{ route('allsubcategory') }}">Sub Category</a>
                    </div>
                </li>
                <li class="menu-item has-submenu">
                    <a class="menu-link" href="{{ route('pendingorders') }}">
                        <i class="icon material-icons md-shopping_cart"></i>
                        <span class="text">Orders</span>
                    </a>
                    <div class="submenu">
                        <a href="{{ route('pendingorders') }}">Pending</a>
                ...
                <li class="menu-item has-submenu">
                    <a class="menu-link" href="{{ route('addproduct') }}">
            ...
            <i class="material-icons md-apps"></i>
              ...
              ></a>
                ...
                <a class="dropdown-item text-danger" href="{{ route('logout') }}"onclick="event.preventDefault();this.closest('form').submit();">
                    <i class="material-icons md-exit_to_app" ></i>{{ ('Log Out') }}
                </a></form>
              </div>
            </li>
          </ul>
