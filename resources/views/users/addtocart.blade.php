        ...
        <div class="row">
                        ...
                        <tbody>
                            ...
                            <tr class="pt-30">
                                @php
                                    ...
                                    $productImage = App\Models\Product::where('id', $items->product_id)->value('image');
                                    $productPrice = App\Models\Product::where('id', $items->product_id)->value('affter_price');
                                @endphp
                                <td class="custome-checkbox pl-30">
                                    <input class="form-check-input" type="checkbox" name="checkbox" id="exampleCheckbox1" value="">
                                    <label class="form-check-label" for="exampleCheckbox1"></label>
                                </td>
                                <td class="image product-thumbnail pt-40"><img src="{{ asset($productImage) }}" alt="#"></td>
                                <td class="product-des product-name">
                                    <h6 class="mb-5"><a class="product-name mb-10 text-heading" href="shop-product-right.html">{{ $productName }}</a></h6>
                                ...
                                <td class="text-center detail-info" data-title="Stock">
                                    <div class="detail-extralink mr-15">
                                        <div class="detail-qty border radius">
                                            ...
                                            <input type="text" name="quantity" class="qty-val" value="{{ $items->quantity }}" >
                                            <a href="#" class="qty-up"><i class="fi-rs-angle-small-up"></i></a>
                                        </div>
                                    </div>
                                </td>
                                <td class="price" data-title="Price">
                                    <h4 class="text-brand">{{ $items->price }}</h4>
                                </td>
                                <td class="action text-center" data-title="Remove"><a href="{{ route('removecartitem', $items->id) }}" class="text-body"><i class="fi-rs-trash"></i></a></td>
                            </tr>   
                            @php
            ...
            <div class="col-lg-4">
                <div class="border p-md-4 cart-totals ml-30">
                   ...
                   @if ($total >0)
                   <a href="{{ route('shippingaddress') }}" class="btn mb-20 w-100 ">Proceed To CheckOut<i class="fi-rs-sign-out ml-15"></i></a>
                    @endif
                </div>
            </div>
        </div>
