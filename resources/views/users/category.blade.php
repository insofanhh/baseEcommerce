                ...
                <div class="row align-items-center">
                    <div class="col-xl-3">
                        ...
                        <div class="breadcrumb">
                            ...
                            <span></span> {{ $category->product_count }} <span></span> {{ $category->category_name }}
                        </div>
                    </div>
                        ...
                        <div class="product-cart-wrap mb-30">
                            ...
                            <div class="product-content-wrap">
                                <div class="product-category">
                                    <a href="shop-grid-right.html">{{ $product->product_category_name }}</a>
                                </div>
                                ...
                                <div class="product-card-bottom">
                                    ...
                                    <div class="add-cart">
                                        <input type="hidden" name="product_id" value="{{ $product->id }}" >
                                            <input type="hidden" name="price" value="{{ $product->affter_price }}" >
            ...
            <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
                <div class="sidebar-widget widget-category-2 mb-30">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="{{ route('category',[$category->id, $category->slug]) }}"> <img src="" alt="" />{{ $category->category_name }}</a><span class="count">{{ $category->product_count }}</span>
                        </li>
                        @endforeach
                    </ul>
                </div>
